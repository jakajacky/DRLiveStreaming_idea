...
#pragma mark -- Set configuration
- (void)resetConfiguration:(LFLiveVideoConfiguration *)configuration {
  _configuration = configuration;
  
  _videoCamera.captureSessionPreset = _configuration.avSessionPreset;
  [_videoCamera.captureSession setSessionPreset:_videoCamera.captureSessionPreset];
